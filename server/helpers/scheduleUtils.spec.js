...
describe('#scheduleTextToObject', () => {
  ...
  test('invalid frequency', () => {
    expect(() =>
      scheduleTextToObject('every 48 hours from 11:25 to 11:24')
    ).toThrow();
  });

  test('indivisible frequency', () => {
    expect(() =>
      scheduleTextToObject('every 15 hours from 18:15 to 18:14')
    ).toThrow();
  });

  test('invalid startTime', () => {
    expect(() =>
      scheduleTextToObject('every 1 hours from 28:12 to 23:16')
    ).toThrow();
  });
